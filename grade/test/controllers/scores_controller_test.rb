...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { deal: @score.deal, name: @score.name, number: @score.number, scores: @score.scores } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { deal: @score.deal, name: @score.name, number: @score.number, scores: @score.scores } }
